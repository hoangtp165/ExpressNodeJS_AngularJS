...
ngFileUpload.version = "10.0.4", ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function (a, b, c) {
    function d(d) {
        function g(a) {
    ...
    function g(a, b, c) {
        ...
        return angular.forEach(a, function (b, c) {
            if (0 === b.type.indexOf("image")) {
                if (e.pattern && !i.validatePattern(b, e.pattern))return;
    ...
    return i.getAttrWithDefaults = function (a, b) {
        ...
        var o = k, p = c && c.$modelValue && (angular.isArray(c.$modelValue) ? c.$modelValue : [c.$modelValue]);
        p = (p || d.$$ngfPrevFiles || []).slice(0);
        var q = h(k, p, d, e);
        k = q.files;
    ...
    return f.validatePattern = function (a, b) {
        ...
        function g(b, d, e) {
            if (a) {
                for (var f = "ngf" + b[0].toUpperCase() + b.substr(1), g = a.length, h = null; g--;) {
                    ...
                    if (i) {
                        var k = j(f, {$file: i});
                        null == k && (k = d(j("ngfValidate") || {}), h = null == h ? !0 : h), null != k && (e(i, k) || (i.$error = b, i.$errorParam = k, a.splice(g, 1), h = !1))
                    }
                }
        ...
        function h(d, e, g, h, i) {
            ...
            if (a) {
                ...
                return a = void 0 === a.length ? [a] : a, angular.forEach(a, function (a) {
                    ...
                    var f = j(l, {$file: a}) || e(j("ngfValidate", {$file: a}) || {});
                    f ? h(a, f).then(function (b) {
                        i(b, f) ? c.resolve() : (a.$error = d, a.$errorParam = f, c.reject())
                    }, function () {
                        j("ngfValidateForce", {$file: a}) ? (a.$error = d, a.$errorParam = f, c.reject()) : c.resolve()
                    }) : c.resolve()
        ...
        var l = b.defer(), m = [];
        return m.push(f.happyPromise(h("maxHeight", function (a) {
            return a.height && a.height.max
        }, /image/, this.imageDimensions, function (a, b) {
            return a.height <= b
        }))), m.push(f.happyPromise(h("minHeight", function (a) {
            return a.height && a.height.min
        }, /image/, this.imageDimensions, function (a, b) {
            return a.height >= b
        }))), m.push(f.happyPromise(h("maxWidth", function (a) {
            return a.width && a.width.max
        }, /image/, this.imageDimensions, function (a, b) {
            return a.width <= b
        }))), m.push(f.happyPromise(h("minWidth", function (a) {
            return a.width && a.width.min
        }, /image/, this.imageDimensions, function (a, b) {
            return a.width >= b
        }))), m.push(f.happyPromise(h("ratio", function (a) {
            return a.ratio
        }, /image/, this.imageDimensions, function (a, b) {
            for (var c = b.toString().split(","), d = !1, e = 0; e < c.length; e++)Math.abs(a.width / a.height - i(c[e])) < 1e-4 && (d = !0);
            return d
        }))), m.push(f.happyPromise(h("maxRatio", function (a) {
            return a.ratio
        }, /image/, this.imageDimensions, function (a, b) {
            return Math.abs(a.width / a.height - i(b)) < 1e-4
        }))), m.push(f.happyPromise(h("minRatio", function (a) {
            return a.ratio
        }, /image/, this.imageDimensions, function (a, b) {
            return Math.abs(a.width / a.height - i(b)) > -1e-4
        }))), m.push(f.happyPromise(h("maxDuration", function (a) {
            return a.duration && a.duration.max
        }, /audio|video/, this.mediaDuration, function (a, b) {
            return a <= f.translateScalars(b)
        }))), m.push(f.happyPromise(h("minDuration", function (a) {
            return a.duration && a.duration.min
        }, /audio|video/, this.mediaDuration, function (a, b) {
            return a >= f.translateScalars(b)
        }))), m.push(f.happyPromise(h("validateAsyncFn", function () {
            return null
        }, null, function (a, b) {
            return b
        }, function (a) {
    ...
    function a(a, c, d, e, f, g, h, i, j) {
        ...
        c[0].addEventListener("dragover", function (b) {
            ...
            if (!k() && i.shouldUpdateOn("drop", d, a)) {
                ...
                if (i.shouldUpdateOn("dropUrl", d, a) && f) {
                    var h;
                    f.replace(/<img .*src *=\"([^\"]*)\"/, function (a, b) {
                        h = b
                    }), h && j({url: h, method: "get", responseType: "arraybuffer"}).then(function (c) {
                        var f = new Uint8Array(c.data), g = c.headers("content-type") || "image/WebP",
                            h = new Blob([f], {type: g});
    ...
    return i.isExifSupported = function () {
        ...
        return e.onload = function (b) {
            ...
            angular.isString(e) ? d.resolve(1) : (a.$ngfOrientation = e, d.resolve(e))
